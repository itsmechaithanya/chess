...
function App() {
  return (
    <div className="h-[120vh] w-screen App flex flex-col items-center justify-center bg-blue-950 text-white">
      <h1 className="text-6xl font-bold mb-3">Chessboard</h1>
      <div className='w-full mb-8 ml-12 mr-12 sm:ml-10 sm:mr-10 '>
